...
circle1 = plt.Circle((0, 0), np.percentile(dist,68), color='g',linewidth=2,linestyle = 'dashed',fill=False)
circle2 = plt.Circle((0, 0), np.percentile(dist,90), color='g',linewidth=2,linestyle = 'dashed',fill=False)
circle3 = plt.Circle((0, 0), np.percentile(dist,95), color='g',linewidth=2,linestyle = 'dashed',fill=False)
...
ax1.hist(delta_ra,bins=20,histtype='step',color='g',linewidth = 2, linestyle = 'dashed', density=True,label='Before')
ax1.hist(delta_ra2,bins=20,histtype='step',color='k',linewidth = 2, density=True,label='After')
ax1.axvline(x=np.median(delta_ra2),color='k')
ax1.axvline(x=np.median(delta_ra),color='g', linestyle = 'dashed')
ax1.xaxis.set_visible(False)
ax1.yaxis.set_visible(False)
ax1.legend()

ax2 = plt.subplot(gs[1:3, 2:3])
ax2.hist(delta_dec,bins=20,histtype='step',color='g',linewidth = 2, linestyle = 'dashed', density=True,orientation='horizontal')
ax2.hist(delta_dec2,bins=20,histtype='step',color='k',linewidth = 2, density=True,orientation='horizontal')
ax2.axhline(np.median(delta_dec2),color='k')
ax2.axhline(np.median(delta_dec),color='g', linestyle = 'dashed')
...
#sns.kdeplot(delta_ra,delta_dec,cmap="Greens", shade=True, shade_lowest=False)
#sns.kdeplot(delta_ra2,delta_dec2,cmap="Greys", shade=True, shade_lowest=False)
ax3.set_xlabel(r'$\Delta$RA (arcsec)')
ax3.set_ylabel(r'$\Delta$DEC (arcsec)')
ax3.set_yticks(np.arange(-2, 3, 1))
ax3.axhline(y=np.median(delta_dec2),color='k')
ax3.axvline(x=np.median(delta_ra2),color='k')
ax3.axhline(y=np.median(delta_dec),color='g', linestyle = 'dashed')
ax3.axvline(x=np.median(delta_ra),color='g', linestyle = 'dashed')
