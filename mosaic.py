...
for band in ['05to7']:
	...
	#w.write('read/fits/size=7200/rebin=4 '+wd+'sim_all/acisf04221_'+band2+'_sim_poiss.fits\n')
	...
	for i in range(len(obs)):
		...
		if obs[i]!='4221':
			...
			#w.write('read/fits/rebin=4 '+wd+'sim_all/acisf'+stem+'_'+band2+'_sim_poiss.fits\n')
	...
	if band =='05to2':
		...
		w2.write('write/fits '+wd+'/xbootes_broad_bkgmap_4rebinned.fits\n')
		w3.write('write/fits '+wd+'/xbootes_broad_expomap_4rebinned.fits\n')
