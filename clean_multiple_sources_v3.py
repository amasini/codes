...
for band in ['broad','soft','hard']:
	...
	cat1=fits.open(wd+'new_mosaics_detection/cdwfs_'+band+'_cat0_exp-psf.fits')
	...
	cat.write(wd+'new_mosaics_detection/cdwfs_'+band+'_cat1_exp-psf.fits',format='fits',overwrite=True)
