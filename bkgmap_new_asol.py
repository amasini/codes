# Create quiescent instrumewntal background from 9-12 keV (flare-filtered) evt files, following
# Hickox & Markevitch 06 coversions to F,S,H bands 
import numpy as np
import sys
...
for i in range(len(obsid)):
	...
	for j in range(len(band)):
		if band[j] == 'broad':
			instrbkg=(0.13+0.27+1.15)*bkg912 #these are cts/s/pixel**2 (F,S,H)
